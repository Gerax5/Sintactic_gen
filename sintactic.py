...
ACTION = {0: {'IDENTIFICADOR': 's1'}, 1: {'ASSIGN': 's3'}, 3: {'IDENTIFICADOR': 's4', 'NUMBER': 's5'}, 6: {'MINUS': 's8', 'PLUS': 's9', '$': 'r0'}, 8: {'IDENTIFICADOR': 's4', 'NUMBER': 's5'}, 9: {'IDENTIFICADOR': 's4', 'NUMBER': 's5'}, 2: {'$': 'acc'}, 4: {'$': 'r5', 'MINUS': 'r5', 'PLUS': 'r5'}, 5: {'$': 'r4', 'MINUS': 'r4', 'PLUS': 'r4'}, 7: {'PLUS': 'r3', '$': 'r3', 'MINUS': 'r3'}, 10: {'PLUS': 'r2', '$': 'r2', 'MINUS': 'r2'}, 11: {'PLUS': 'r1', '$': 'r1', 'MINUS': 'r1'}}
