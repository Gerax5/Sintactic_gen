...
ACTION = {0: {'IDENTIFICADOR': 's1'}, 1: {'ASSIGN': 's3'}, 3: {'IDENTIFICADOR': 's4', 'NUMBER': 's5'}, 6: {'MINUS': 's8', 'PLUS': 's9', '$': 'r0'}, 8: {'IDENTIFICADOR': 's4', 'NUMBER': 's5'}, 9: {'IDENTIFICADOR': 's4', 'NUMBER': 's5'}, 2: {'$': 'acc'}, 4: {'MINUS': 'r5', '$': 'r5', 'PLUS': 'r5'}, 5: {'MINUS': 'r4', '$': 'r4', 'PLUS': 'r4'}, 7: {'MINUS': 'r3', 'PLUS': 'r3', '$': 'r3'}, 10: {'MINUS': 'r2', 'PLUS': 'r2', '$': 'r2'}, 11: {'MINUS': 'r1', 'PLUS': 'r1', '$': 'r1'}}
